...
public class UsuarioOld implements Serializable
{
    ...
    public UsuarioOld(String email, String senha, String msg) throws Exception {
     ...
     * @throws Exception
     */
    public UsuarioOld(String nome, String email, String senha, String msg) throws Exception {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UsuarioOld other = (UsuarioOld) obj;
		if (email == null) {
			if (other.email != null)
				return false;
